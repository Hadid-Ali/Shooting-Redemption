  ...
  //  [RequireComponent(typeof(Rigidbody))]
    public class CharacterMotor : MonoBehaviour
    {
        ...
        public void OnHit(Hit hit)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    _animator.SetFloat("GetHitType", -1);//Ibrahim
               ...
               if(!ismainplayer) _animator.SetTrigger("GetHit");
            }
        ...
        public void NotifyZoom()
        {
            ...
            {
                _visibility[i].GetComponent<Renderer>().enabled = false;
            }
        ...
        public void NotifyUnzoom()
        {
            for (int i = 0; i < _visibility.Length; i++)
            {
                _visibility[i].GetComponent<Renderer>().enabled = true;
            }
