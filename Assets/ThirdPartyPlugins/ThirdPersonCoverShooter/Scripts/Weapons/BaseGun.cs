...
namespace CoverShooter
{
    ...
    public abstract class BaseGun : MonoBehaviour
    {
        ...
        /// </summary>
        public Vector3 Origin { get { return CustomAim == null ? transform.position : CustomAim.transform.position; } }
        ...
        private Renderer[] _customRenderers;
        ...
        [SerializeField]private GameObject _customListenerGameObject;
        private IGunListener _customListener;
        ...
        protected virtual void Awake()
        {
            ...
            _customRenderers = GetComponentsInChildren<Renderer>();
        ...
        {
            if (isMainPlayer)
                foreach (var t in _customRenderers)
                    t.enabled = !Character.IsZooming;
